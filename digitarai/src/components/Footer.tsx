        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 border-b border-slate-900 pb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex items-center gap-3">
              ...
              <a
                href="https://x.com/digitarai"
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 rounded-xl bg-slate-900 hover:bg-slate-800 hover:text-white flex items-center justify-center border border-slate-800 transition text-slate-400"
                aria-label="X (formerly Twitter)"
              >
                <Twitter className="w-4 h-4" />
              </a>
              <a
                href="https://instagram.com/digitarai"
                target="_blank"
                rel="noopener noreferrer"
          ...
          {/* Column 4: Contact Us Interaction Block */}
          <div>
